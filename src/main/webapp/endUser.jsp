    ...
    <body>
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
                ...
                <h2 style="float: right; margin-right: 35px; font-size: 20px; color:black;"><%=user.getUserName()%></h2>
                <a href="logoutServlet.jsp"><button class="btn btn-outline-success" type="submit">Logout here</button></a>
            </div>
        </nav>
    </body>
</html>